...
ActiveRecord::Schema.define(version: 20150219170154) do
  ...
  create_table "build_stats", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "num_feature_bugs"
    t.integer  "num_software_bugs"
    t.integer  "num_software_miss"
    t.integer  "num_automation_bugs"
    t.integer  "num_automation_miss"
    t.integer  "num_analysis_bugs"
    t.integer  "num_analysis_miss"
    t.integer  "num_total_scenarios_with_software"
    t.integer  "automation_goal_progress"
    t.integer  "num_failed_bugs"
    t.integer  "num_pending_bugs"
    t.integer  "num_passed_wip_scenarios"
    t.integer  "num_failed_bugs_scenarios"
    t.integer  "num_pending_bugs_scenarios"
    t.integer  "num_regression_bugs_scenarios"
  end

  add_index "build_stats", ["build_id"], name: "index_build_stats_on_build_id"
  ...
  create_table "builds", force: true do |t|
    ...
    t.string   "intent"
    t.string   "commit_id"
    t.text     "step_definitions"
    t.text     "step_definition_matches"
  end
  ...
  create_table "projects", force: true do |t|
    ...
    t.string   "ci_url"
    t.string   "ci_username"
    t.string   "ci_password"
    t.string   "ci_job_name"
    t.string   "git_url"
    t.decimal  "passed_goal"
    t.decimal  "automation_goal"
    t.string   "test_path"
    t.string   "webcat_token"
  end
  ...
  create_table "step_screenshots", force: true do |t|
    t.string   "scenario_id"
    t.integer  "step_order"
    t.integer  "ss_order"
    t.text     "shot",        limit: 16777215
    t.integer  "build_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "location"
  ...
  add_index "step_screenshots", ["build_id"], name: "index_step_screenshots_on_build_id"
  ...
  create_table "test_issues", force: true do |t|
    t.boolean  "dirty"
    t.integer  "subtype"
    t.integer  "build_id"
    t.datetime "created_at"
  ...
  add_index "test_issues", ["build_id"], name: "index_test_issues_on_build_id"
